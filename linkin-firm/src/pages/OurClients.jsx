...
const englishText = {
  ...
  clients: [
    ...
    { img: AppProva, title: 'AppProva', subtitle: 'Plataforma de diagnóstico acadêmico ' },
    { img: Asics, title: 'Asics', subtitle: 'Empresa de artigos desportivos' },
    { img: Avianca, title: 'Avianca airlines', subtitle: 'Companhia aérea brasileira' },
    { img: Babolat, title: 'Babolat', subtitle: 'Empresa de equipamento esportivos' },
    { img: BB, title: 'Banco do Brasil', subtitle: 'instituição financeira brasileira' },
    { img: Barracuda, title: 'Barracuda', subtitle: 'Empresa de segurança, rede e armazenamento ' },
    { img: BMG, title: 'Banco BMG', subtitle: 'Instituição financeira do Brasil' },
    { img: Ecosolys, title: 'Ecosolys', subtitle: 'Fabricante de produtos para energia solar' },
    { img: CLaro, title: 'Claro', subtitle: 'Serviço de telefonia' },
    { img: SLconstrutora, title: 'SL Construtora', subtitle: 'Empresa de construção civil' },
    { img: Correios, title: 'Correios', subtitle: 'Empresa de entrega de correspondências' },
    { img: Csul, title: 'Csul', subtitle: 'Projeto de desenvolvimento urbano' },
    { img: Daylong, title: 'Daylong', subtitle: 'Fabricante de produtos dermocosméticos' },
    { img: Deloitte, title: 'Deloitte', subtitle: 'Consultoria de gerenciamento' },
    { img: Estacio, title: 'Estácio', subtitle: 'Universidade privada brasileira' },
    { img: Faberg, title: 'Faberg', subtitle: 'Empresa de eventos esportivos' },
    { img: Gillette, title: 'Gillette', subtitle: 'Fabricante de produtos de higiene pessoal' },
    { img: Grasp, title: 'Grasp', subtitle: 'Industria de biotecnologia' },
    { img: Hidracor, title: 'Hidracor', subtitle: 'Produtos para pintura imobiliária' },
    { img: Insperiência, title: 'Insperiência', subtitle: 'Consultoria de desenvolvimento' },
    { img: Joma, title: 'Joma', subtitle: 'Fornecedora de material esportivo ' },
    { img: LandRover, title: 'Land Rover', subtitle: 'Fabricante de veículos automotores' },
    { img: MacMillan, title: 'MacMillan', subtitle: 'Editora de livros didáticos' },
    { img: Motorola, title: 'Motorola', subtitle: 'Fabricante de produtos eletrônicos' },
    { img: MRV, title: 'MRV', subtitle: 'Construtora imobiliária' },
    { img: OptimumNutrition, title: 'Optimum Nutrition', subtitle: 'Nutrição esportiva' },
    { img: Solinco, title: 'Solinco', subtitle: 'Fabricante de artigos esportivos' },
    { img: TennisRoute, title: 'Tennis Route', subtitle: 'Centro de treinamento de tênis' },
    { img: UomoSport, title: 'Uomo Sport', subtitle: 'Fabricante de materiais esportivos' },
    { img: WellFargos, title: 'Well Fargos', subtitle: 'Consultoria financeira' },
    { img: Wilson, title: 'Wilson', subtitle: 'Fabricante de artigos esportivos' },
    { img: XPInvestimentos, title: 'XP Investimentos', subtitle: 'Corretora de Câmbio, Títulos e Valores Mobiliários' },
  ],
};
